        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div" sx={{ mr: 2, ...(open && { display: 'none' }) }}>
                        GREENWICH
                    </Typography>
                    <Box sx={{ width: '50ch' }}>
                        <TextField
                    ...
                    <IconButton onClick={() => { }} sx={{ marginLeft: 5 }}>
            ...
            >
                <DrawerHeader>
                    ...
                    <IconButton onClick={handleDrawerClose}>
                        {theme.direction === 'ltr' ? <ChevronLeftIcon style={{ color: 'rgb(217, 217, 217)' }} /> : <ChevronRightIcon />}
                    </IconButton>
                </DrawerHeader>
                <Divider />
                <List>
